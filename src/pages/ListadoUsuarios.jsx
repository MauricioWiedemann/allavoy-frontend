                ...
                {<div className="viajes-list">
                    {usuariosOrdenados.map((usuario, index) => (
                        <div key={index} className="viaje-card card p-4 shadow-lg">
                            ...
                            {
                                usuario.activo ? (<button className="btn btn-primary btn-sm rounded-pill comprar-btn" onClick={() => desactivar_usuario(usuario)}>Desactivar</button>) : (<button className="btn btn-primary btn-sm rounded-pill comprar-btn" disabled>Desactivar</button>)
                            }
                        </div>
                    ))}
                </div>}
